...
optimization_results = np.load(os.path.join(results_path,'q0.npz'))
...
# fig.tight_layout()
# axs.contour(x, y, results, levels=18, cmap='rainbow',alpha = 0.7, zorder = -50)
# axs.set_xlim(-5,5)
# axs.set_ylim(-5,5)
